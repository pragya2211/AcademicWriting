...
<head>
    ...
    <title>Department Of Social Sciences and Humanities - IIIT Delhi</title>
<meta name="google-site-verification" content="wV4tYW_sJxchNpfqS3Tpc7_M8XWEunDxM3mE6F9S4TI" />
<meta name="keywords" content="Department Of Social Sciences and Humanities, SSH IIITD, SSH IIIT Delhi" />
...
<body>
    ...
    <div class="top_links"><h1><a style="color: #3fada8;text-decoration: none;" href="./index.php">Academic Writing Lab</a> </h1></div>



    <div id = "menu" style="height: 40px; width: 1000px;">
        <ul>
          <li><a href="index.php">Home</li>
          <li><a href="WritingCourses.php">Courses</a></li>
          <li><a href="Workshop.php">Workshops/Sessions</a></li>
          <li><a>Contact us</a>
            <ul>
